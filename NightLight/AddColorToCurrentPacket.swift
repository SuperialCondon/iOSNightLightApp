...
protocol AddColorToCurrentPacketDelegate{
    func changePacketTitle(oldTitle: String, newTitle: String);
}

class AddColorToCurrentPacket: UIViewController {
    ...
    var delegate : AddColorToCurrentPacketDelegate! = nil
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        colorPacketTextField.text = viewTitle
    }
    ...
    override func viewDidDisappear(animated: Bool) {
        let previousTitle = viewTitle
        viewTitle = colorPacketTextField.text!
        delegate.changePacketTitle(previousTitle, newTitle: viewTitle)
    }
